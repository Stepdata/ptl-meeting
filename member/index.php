                ...
                <div class="row" >
                    <div class="col-xs-12">
						...
						<?php if ($_GET['action']=='') {
							...
							if (isset($_GET['list']))
							{
								$meSQL = "SELECT * FROM tb_member where active = {$_GET['list']} ORDER BY id_member asc";
							}
							else
							{
						...
						<?php if ($_GET['action']=='add') {?> 
							<form class="form-horizontal" role="form" name="formregister" method="post" action="member\action.php?action=add">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text"  name="title" id="title" placeholder="title" class="col-xs-10 col-sm-5" value="" required />
									</div>
								</div>   
								<div class="form-group">
								...
								<div class="form-group">
									...
									<label class="col-sm-3 control-label no-padding-right" for="title"> คำนำหน้า </label>
									<div class="col-sm-9">
									<input type="text"  name="title" id="title" placeholder="title" class="col-xs-10 col-sm-5" value="<?php echo $meResult['ntitle'];?>" required />
									</div>
