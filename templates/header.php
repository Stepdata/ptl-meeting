					...
					<?php if ($_SESSION['id'] != '') {?> 
						<ul class="nav ace-nav">
							<?php 	if ($_SESSION['status'] == 'admin') {
								...
								$sql3 = "SELECT COUNT(id_member) AS count1 FROM tb_member WHERE active = 0 ";
								$rs3 = $conn->query($sql3)->fetch_assoc();
							?>					
							<li class="transparent dropdown-modal open">
								<a class="dropdown-toggle" href="index.php?page=member&list=0" >
									<i class="fa fa-group"></i>
									<span class="badge badge-important"><?php if ($rs3['count1']==0){echo '';}else {echo $rs3['count1'];}?></span>
								</a>
							</li>
