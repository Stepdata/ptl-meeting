                    ...
                    <div class="col-sm-12">
						...
						<?php if ($_GET['action']=='') { ?>					
							<div class="form-group" style="padding-left:50px">
								...
								<a href="report/action.php?action=change&id=<?php echo $rs['id']; ?>
																		&status=<?php echo '1'; ?>
																		&his_topic=<?php echo $rs['title']; ?>
																		&his_client=<?php echo $rs['member']; ?>
																		&his_room=<?php echo $rs['name_rooms']; ?>
																		" class="tooltip-info" data-rel="tooltip" title="อนุมัติ" OnClick="return chk1();">
								<span class="green">
								<i class="fa fa-check " style="font-size:17px;" aria-hidden="true" ></i>	
								...
								<a href="report/action.php?action=change&id=<?php echo $rs['id']; ?>
																		...
																		&his_client=<?php echo $rs['member']; ?>
																		&his_room=<?php echo $rs['name_rooms']; ?>
																		" class="tooltip-info" data-rel="tooltip" title="ไม่อนุมัติ" OnClick="return chk2();">
								<span class="blue">
								<i class="fa fa-ban" style="font-size:17px;" aria-hidden="true"></i>
								</span>
								</a>
								...
								<a href="report/action.php?action=change&id=<?php echo $rs['id']; ?>
																		...
																		&his_client=<?php echo $rs['member']; ?>
																		&his_room=<?php echo $rs['name_rooms']; ?>
																		" class="tooltip-info" data-rel="tooltip" title="ยกเลิก" OnClick="return chk3();">
								<span class="red">
								<i class="fa fa-times" style="font-size:17px;" aria-hidden="true"></i>
								</span>
								</a>
								...
								<a class="green" href="index.php?page=report&action=edit&id=<?php echo $rs['id']; ?>&report=<?php echo $_GET['report']; ?>">
								<i class="ace-icon fa fa-pencil bigger-130"></i>
								</a>
								<a class="blue" href="javascript:popup('report/print.php?id=<?php echo $rs['id']; ?>','',680,500)">
								<i class="ace-icon glyphicon glyphicon-print bigger-130"></i>
								</a>
								<a class="red" href="report/action.php?action=delete&id=<?php echo $rs['id']; ?>&report=<?php echo $_GET['report']; ?>" OnClick="return chkdel();">
