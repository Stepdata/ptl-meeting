...
<div class="form-group">
	<label class="col-sm-3 control-label no-padding-right" for="People"> จำนวนคน </label>
      <div class="col-sm-9">
	<input type="text" name="People" id="People" placeholder="" class="col-xs-10 col-sm-5" value="" required />
      </div>
</div>
<div class="form-group">
...
<div class="form-group">
	<label class="col-sm-3 control-label no-padding-right" for="People"> จำนวนคน </label>
      <div class="col-sm-9">
	<input type="text" name="People" id="People" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo $meResult['people_rooms'];?>" required />
      </div>
</div>
<div class="form-group">
	<label class="col-sm-3 control-label no-padding-right" for="Detail"> รายละเอียด </label>
